...
const EditItemForm = ({ open, onUpdate, onCancel, initialData }) => {
    ...
    const handleUpdate = async () => {
        try {
            ...
            formData.append('name', values.name); // Serialize the description list
            ...
            try {
                const response = await axios.put(`http://localhost:3000/customers/update/${initialData._id}`, formData, {
                    headers: {
