...
import DataTable from '../../Components/CustomerCompo/CustomerCompo';
import AddItemForm from '../../Components/CustomerCompo/AddItmeCompo';
import EditItemForm from '../../Components/CustomerCompo/EditeFormCompo'; // Import EditItemForm
...
function CustomerAdmin() {
  ...
  const handleDelete = (item) => {
    ...
    Modal.confirm({
      ...
      onOk: async () => {
        try {
          await axios.delete(`http://localhost:3000/customers/delete/${item._id}`);
