...
import DataTable from '../../Components/ProjectCompo/ProjectCompo';
import AddItemForm from '../../Components/ProjectCompo/AddItmeCompo';
import EditItemForm from '../../Components/ProjectCompo/EditeFormCompo'; // Import EditItemForm
...
function ProjectAdmin() {
  ...
  const handleDelete = (item) => {
    ...
    Modal.confirm({
      ...
      onOk: async () => {
        try {
          await axios.delete(`http://localhost:3000/project/delete/${item._id}`);
